...
describe('AppButton', () => {
  ...
  it('applies the accent variant class', () => {
    const wrapper = mount(AppButton, { props: { variant: 'accent' } })
  ...
  it('renders a leading icon when icon prop is provided', () => {
    const wrapper = mount(AppButton, { props: { icon: 'plus' } })
    expect(wrapper.find('svg').exists()).toBe(true)
  })

  it('renders a trailing icon when iconTrailing prop is provided', () => {
    const wrapper = mount(AppButton, { props: { iconTrailing: 'plus' } })
    expect(wrapper.find('svg').exists()).toBe(true)
  })
...
describe('AppIconButton', () => {
  it('renders an svg icon', () => {
    const wrapper = mount(AppIconButton, { props: { icon: 'plus' } })
    expect(wrapper.find('svg').exists()).toBe(true)
  })
  ...
  it('applies ghost variant class', () => {
    const wrapper = mount(AppIconButton, { props: { icon: 'plus', variant: 'ghost' } })
    expect(wrapper.classes()).toContain('icon-button--ghost')
  })

  it('applies the size via the --icon-button-size custom property (WEB-W2-41)', () => {
    const wrapper = mount(AppIconButton, { props: { icon: 'plus', size: 48 } })
  ...
  it('passes type prop to native button', () => {
    const wrapper = mount(AppIconButton, { props: { icon: 'plus', type: 'submit' } })
    expect(wrapper.attributes('type')).toBe('submit')
  })
  ...
  it('disables the button when disabled is true', () => {
    const wrapper = mount(AppIconButton, { props: { icon: 'plus', disabled: true } })
    expect(wrapper.attributes('disabled')).toBeDefined()
  })
