<template>
  <div>
    ...
    <Card class="mb-5">
      ...
      <div v-if="todayStore.loading" class="mt-2 text-[13px] text-muted">
        Loading…
      </div>
      ...
      <p v-else class="mt-2 text-[13px] text-muted">
    ...
    <Card variant="accent" class="mb-5">
      ...
      <p v-if="reviewStore.error" class="mt-2 text-[12px] text-bad">
        {{ reviewStore.error }}
      </p>
    </Card>
  </div>
