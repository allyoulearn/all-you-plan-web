...
<script>
/**
 * AppSegmentedControl — pill-shaped tab switcher with v-model binding.
 *
...
export default {
  ...
  setup(props, { emit }) {
    ...
    /**
     * Move the selection to the option at `idx`, wrapping around at both
     * ends so arrow-key navigation never gets stuck at an edge. No-ops when
     * there are no options.
     *
     * @param {number} idx - Target option index (may be negative or >= length).
     */
    function moveTo(idx) {
